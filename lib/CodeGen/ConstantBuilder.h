...
public:
  ...
  public:
    ...
    /// Add a pointer cast of a value to a specific type.
    void addPointerCast(llvm::Constant *value, llvm::Type *type) {
      add(llvm::ConstantExpr::getPointerCast(value, type));
    }
...
private:
  llvm::GlobalVariable *createGlobal(llvm::Constant *initializer,
    ...
    return createGlobal(initializer,
                        name,
                        alignment,
                        constant,
                        linkage,
